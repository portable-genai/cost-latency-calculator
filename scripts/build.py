...
def S(id, repo, name, unit, short, tag, flags, defaults):
    return {"id": id, "repo": repo, "name": name, "unitLabel": unit, "unitShort": short,
            "tagline": tag, "flags": flags, "defaults": defaults}

SYSTEMS = [
 S("Hrz1","agent-guardrail-gateway","Agent Guardrail Gateway","Guardrail screens","screen",
 ...
 S("Hrz2","enterprise-knowledge-base","Enterprise Knowledge Base","KB searches","search",
 ...
 S("Hrz3","agent-registry","Agent Registry & Governance","Registry ops","op",
   "Agent registry, identity, scoped entitlements, discovery.",
   {"dbOnly":1},
   {"volumePerDay":100000,"burst":4,"activeHoursPerWeek":120}),
 S("Hrz4","model-quality-gate","AI Quality & Model-Risk","Eval runs","run",
 ...
 S("Hrz5","agent-observability","Observability, Audit & FinOps","Audited events","event",
 ...
 S("Doc1","cdd-sow-research","CDD + Source of Wealth Agent","CDD cases","case",
 ...
 S("Doc2","credit-memo-drafting","Credit-Memo / Underwriting Assistant","Credit memos","memo",
 ...
 S("Doc3","cio-advisory","Personalised CIO Advisory Assistant","Advisory briefings","briefing",
 ...
 S("Doc4","trade-finance-checker","Trade-Finance Document Checker (UCP600)","LC presentations","presentation",
 ...
 S("Doc5","loan-document-intelligence","Loan / Mortgage Document Intelligence","Loan applications","application",
 ...
 S("Doc6","complaints-review","Complaints & Conduct File Review","Complaint files","file",
 ...
 S("Rsk1","compliance-advisory","Compliance Assistant","Compliance questions","question",
 ...
 S("Rsk2","compliance-advisory","Cloud Control-Mapping Toolkit","Evidence packs","pack",
 ...
 S("Rsk3","architecture-validator","Architecture & Requirements Validator","Project validations","validation",
 ...
 S("Rsk4","architecture-validator","Data Residency / Sovereignty Validator","IaC scans","scan",
 ...
 S("Rsk5","operational-resilience-mapping","Exit & Portability Planner","Exit plans","plan",
...
def emit_pages():
    n = 0
    for s in SYSTEMS:
        repo_dir = os.path.join(HOME, "git", s["repo"])
        if not os.path.isdir(repo_dir):
            print("  MISSING repo:", s["repo"]); continue
        html = PAGE % {"name": s["name"], "id": s["id"], "cdn": CDN, "eref": ENGINE_REF, "pref": PRICES_REF}
